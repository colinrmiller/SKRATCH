...
insert into [Note] (Id, Content, UserId, DateAdded, DateUpdated, DateStart, DateEnd, IsStaged) values (2, 'Test\n #TAG #PROJECT\n - Action 1 #TASK\n ', 1, '2020-05-19','2020-05-19','2022-02-03','2020-02-04', 1);
insert into [Note] (Id, Content, UserId, DateAdded, DateUpdated, DateStart, DateEnd, IsStaged) values (3, 'Test\n #JENKINS #Review\n - Installed on port 8080\n - CI/CD App', 1, '2020-05-19','2020-05-19','2022-02-02','2020-02-04', 0);
